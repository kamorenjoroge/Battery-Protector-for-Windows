...
Download the published installer (setup.exe)
Run the installer
BatteryGuard will start automatically and appear in the system tray
Option 2: Portable EXE
Download the .exe file
Run it directly (requires .NET Framework installed)
🧪 How It Works
